    ...
    return (
        <>
            <div className="input-group">
                ...
                <span className="input-group-text rounded-end-3" role='button' onClick={onClick} style={{ border: "1px solid #800000", color: "#6C757D", backgroundColor: "#F5F5F5" }}><i className="fa-solid fa-magnifying-glass fa-lg"></i></span>
            </div>
            <style>
                {`
input::placeholder {
