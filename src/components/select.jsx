...
function SelectCom() {
    ...
    return (
        <>
            <select onChange={(e) => setSelectedValue(e.target.value)} defaultValue="default" id={id} className='form-select shadow-none ps-3 pe-5 py-3 rounded-3' style={{ color: selectedValue == "default" ? "#6C757D80" : "black", fontWeight: "bold", border: "1px solid #800000", backgroundColor: "#F5F5F5" }}>
